...
$action = JRoute::_('index.php?option=com_truematrimony&view=profile&task=save');
?>
	...
	<div class="row-fluid">
		...
		<div class="matrimony-register">		
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" class="matrimony-reg-name has-error" id="matrimony-reg-name" value="<?php echo $this->item->profile_name; ?>" required>			
				</div>
			...
			<div class="control-group">
			    ...
			    <!-- register email -->
			    <div class="controls">
			    	<input type="email" name="email" id="email" value="<?php echo $this->item->email; ?>" required>
			    </div>
