...
<div class="row-fluid">
      	...
      	<form class="form-horizontal" role="form" name="adminForm" id="adminForm" method="post" action=<?php echo JUri::root().'index.php?option=com_truematrimony&view=search&layout=item' ?> >	  		  
			...
			<div class="control-group">
				...
				<label class="control-label"><?php echo JText::_('COM_TRUEMATRIMONY_SEARCH_OPTIONS'); ?></label>
											
				<!-- control group search age starts -->
				<div class="control-group search-age">
								
					<input type="text" name="from-age" class="mini" id="from-age" value="" size="10" placeholder="Age From">
						
					<input type="text" name="to-age" id="to-age" value="" size="10" placeholder="Age To">
