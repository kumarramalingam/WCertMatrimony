...
<form class="matrimony-additional-form form-horizontal" role="form" id="adminForm" name="adminForm" method="post">
	...
	<div class="row-fluid">		
	    ...
	    <div class="matrimony-family-info">
			...
			<!-- register mother kuttam div starts -->
			<div class="control-group">
				
				<!-- register mother kuttam label -->
				<label class="control-label" for="<?php echo JText::_('COM_MATRIMONY_REGISTER_MOTHER_KUTTAM')?>">
					<?php echo JText::_('COM_MATRIMONY_REGISTER_MOTHER_KUTTAM'); ?>
				</label>
				
				<!-- country select list -->
				<div class="controls">
					<?php 
						$result = TrueMatrimonyHelperSelect::getMotherKuttamlist('motherkuttam_id','',$this->item->motherkuttam_id);
						echo JHtml::_('select.genericlist', $result, 'motherkuttam_id', 'text', $this->item->motherkuttam_id);
					?>					
			    </div>
			    
			</div><!-- register mother kuttam div ends -->			
			...
			<!-- control group address div starts -->
			<div class="control-group">
				
				<!-- register address label -->
				<label class="control-label" for="<?php echo JText::_('COM_TRUEMATRIMONY_REGISTER_PROFILE_ADDRESS')?>">
					<?php echo JText::_('COM_TRUEMATRIMONY_REGISTER_PROFILE_ADDRESS'); ?>
				</label>
				
				<!-- register address div starts -->
				<div class="controls">
					<input type="text" class="matrimony-reg-name has-error" id="profile_address" name="profile_address" value="<?php echo $this->item->profile_address; ?>" >			
				</div>
			
			</div><!-- control address name div ends -->
			
			<!-- control group website div starts -->
			<div class="control-group">
				
				<!-- register website label -->
				<label class="control-label" for="<?php echo JText::_('COM_TRUEMATRIMONY_REGISTER_PROFILE_WEBSITE')?>">
					<?php echo JText::_('COM_TRUEMATRIMONY_REGISTER_PROFILE_WEBSITE'); ?>
				</label>
				
				<!-- register website div starts -->
				<div class="controls">
					<input type="text" class="matrimony-reg-name has-error" id="profile_website" name="profile_website" value="<?php echo $this->item->profile_website; ?>" >			
				</div>
			
			</div><!-- control website name div ends -->		
